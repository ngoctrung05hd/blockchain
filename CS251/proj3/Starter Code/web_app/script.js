...
async function add_IOU(creditor, amount) {
	const debtor = await BlockchainSplitwise.getAddress();

  const cycle = doBFS(creditor, debtor, getNeighbors);  
  if (cycle != null)
    await BlockchainSplitwise.add_IOU(creditor, amount, cycle);
}
